...
const CostCalculatorTab: React.FC<CostCalculatorTabProps> = ({ onOptimizationStatusChange }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="mb-6">
        <h3 className="text-lg font-medium text-gray-900 mb-2">Gefundene Optimierungen</h3>
        <p className="text-gray-600">
          Übersicht aller identifizierten Optimierungsmöglichkeiten und deren Status.
        </p>
      </div>

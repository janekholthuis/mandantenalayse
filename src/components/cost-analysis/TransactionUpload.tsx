    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
        <label className="flex items-start">
          ...
          <div className="text-sm text-gray-700">
            ...
            <div>
              Ich bestätige, dass ich zur Verarbeitung dieser Buchungsdaten berechtigt bin 
              und alle datenschutzrechtlichen Bestimmungen einhalte.
            </div>
          </div>
        </label>
      </div>
      ...
      <div className="flex justify-between">
        ...
        <Button
          ...
          disabled={!gdprConsent || isProcessing || (!skipErrors && validationErrors.length > 0)}
          isLoading={isProcessing}
          className="bg-green-600 hover:bg-green-700 px-8"
        >
          {isProcessing ? 'Importiere...' : `Import starten`}
        </Button>
      </div>
    </div>
  );
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-green-800 mb-3">
          🎉 Buchungsdaten erfolgreich importiert!
        </h2>
        <p className="text-lg text-green-700 mb-2">
          {mappedData.length} Buchungen wurden analysiert.
        </p>
        <p className="text-green-600 mb-6">
          7 Verträge mit möglichem Einsparpotenzial identifiziert.
        </p>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <div className="flex items-center justify-center text-sm text-gray-500">
          ...
          <span>🔒 Ihre Daten werden gemäß DSGVO verarbeitet und verschlüsselt übertragen.</span>
        </div>
        <div className="text-center mt-2">
          <span className="text-xs text-gray-500">
            📞 Fragen? Kontaktieren Sie support@mandantenanalyse.com
          </span>
        </div>
      </div>
    </div>

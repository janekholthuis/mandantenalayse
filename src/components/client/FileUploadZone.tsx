...
const FileUploadZone: React.FC<FileUploadZoneProps> = ({ onFileSelect, onBack, isProcessing }) => {
      ...
      {isProcessing && (
        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center">
            ...
            <span className="text-sm text-blue-700 font-medium">Datei wird geprüft...</span>
          </div>
        </div>
      )}
